...
{
    /// <summary>
    ///     Class which allows for unsafe conversion of arrays from one type to another. Does not create copies of the arrays,
    ///     instead
    ...
    internal sealed unsafe class ArrayConverter
    {
        ...
        private static readonly int
            MethodTableOffset; // offset (in units of size_t bytes) of method table from start of array data. -2 for .NET CLR, -4 for Mono
        ...
        static ArrayConverter()
        {
            ...
            _changeToByte2 =
                typeof(ArrayConverter).GetMethod("ChangeToByte2", BindingFlags.Static | BindingFlags.Public);
        ...
        /// <summary>
        ///     Changes the array type to T[] and the length to newLen. Modifies the array itself; does not return a copy of the
        ///     array.
        ///     This is very, very thread-unsafe. Be 200% sure that no other thread can access the array when it's in its changed
        ///     state.
        ...
        /// <summary>
        ///     Changes the array type to byte[] and the length to newLen. Modifies the array itself; does not return a copy of the
        ///     array.
        ///     This is very, very thread-unsafe. Be 200% sure that no other thread can access the array when it's in its changed
        ///     state.
        ///     The array must not be null or empty.
        ...
        /// <summary>
        ///     Called by the generated shim for changing T[] to byte[]. Just calls <see cref="ChangeArrayType" /> with the correct
        ///     args.
        ///     Note this method is public so it can be accessed by the generated code. It should not be used from outside this
        ///     class.
        /// </summary>
